...
module.exports = (sequelize, DataTypes) => {
  class secondary_pricing extends Model {
    static associate(models) {
      ...
      this.hasOne(models.unit_customises,{foreignKey:"secondary_pricing_id"})    }
  }
  secondary_pricing.init({
    id: {
      allowNull: false,
      primaryKey: true,
